...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mon Aug 7 09:20:40 2017
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/rgbhsv_qt1.0.0/ && $(COPY_FILE) --parents rgbhsv_qt.ui .tmp/rgbhsv_qt1.0.0/ && (cd `dirname .tmp/rgbhsv_qt1.0.0` && $(TAR) rgbhsv_qt1.0.0.tar rgbhsv_qt1.0.0 && $(COMPRESS) rgbhsv_qt1.0.0.tar) && $(MOVE) `dirname .tmp/rgbhsv_qt1.0.0`/rgbhsv_qt1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/rgbhsv_qt1.0.0
