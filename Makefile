#############################################################################
# Makefile for building: rgbhsv_qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed Aug 9 22:20:04 2017
# Project:  rgbhsv_qt.pro
# Template: app
# Command: /usr/lib64/qt4/bin/qmake -o Makefile rgbhsv_qt.pro
#############################################################################
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/rgbhsv_qt1.0.0/ && $(COPY_FILE) --parents ui_rgbhsv_qt.h .tmp/rgbhsv_qt1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/rgbhsv_qt1.0.0/ && $(COPY_FILE) --parents rgbhsv_qt.ui .tmp/rgbhsv_qt1.0.0/ && (cd `dirname .tmp/rgbhsv_qt1.0.0` && $(TAR) rgbhsv_qt1.0.0.tar rgbhsv_qt1.0.0 && $(COMPRESS) rgbhsv_qt1.0.0.tar) && $(MOVE) `dirname .tmp/rgbhsv_qt1.0.0`/rgbhsv_qt1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/rgbhsv_qt1.0.0
